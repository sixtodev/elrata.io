            ...
            <div className="space-y-10 text-[15px] leading-relaxed">
              ...
              <section>
                ...
                <p className="text-muted">
                  <strong className="text-foreground">Ejemplo concreto:</strong> el scraping de esta app. Hay mil servicios de pago para eso, pero yo quería la opción más free y rata posible. Investigué, probé, descarté, volví a probar. El resultado funciona bien — con sus limitaciones, claro. La más memorable: MercadoLibre me baneó la IP del VPS. Literalmente. Me bloqueó el servidor entero. En algún punto eso deja de ser un error y empieza a ser un logro.
                </p>
              </section>
